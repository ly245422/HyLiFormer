...
def get_parser():
    parser = argparse.ArgumentParser(description='HyLiFormer: Hyperbolic Linear Transformer for Skeleton-based Human Action Recognition')
    ...
    # poincare
    parser.add_argument('--curvature', type=float, default=-1.0, help='curvature of the Poincaré model')
